...
import { HomeOutlined, CarOutlined, EnvironmentOutlined, ScheduleOutlined, HeartOutlined, BarChartOutlined, ToolOutlined, WalletOutlined, GiftOutlined, ShoppingOutlined, SearchOutlined, CloseOutlined, SwapOutlined, ThunderboltOutlined } from '@ant-design/icons'
...
export default function AppHeader() {
  ...
  const menuItems = [
    ...
    { key: '/map-tools', icon: <ThunderboltOutlined />, label: '地图工具' },
